  ...
  render: (args: PlaygroundArgs) => <div {...stylex.props(styles.pageWrapper)}>
      <Card width={args.cardWidth} height={args.cardHeight}>
        <Layout padding={args.layoutPadding} header={args.showHeader ? <LayoutHeader hasDivider={args.headerHasDivider} padding={args.headerPadding}>
              ...
              </LayoutHeader> : undefined} start={args.showStartPanel ? <LayoutPanel width={args.startPanelWidth} height={args.startPanelHeight} hasDivider={args.startPanelHasDivider} isScrollable={args.startPanelIsScrollable} role="navigation">
                <NavItem active>Dashboard</NavItem>
                <NavItem>Settings</NavItem>
                <NavItem>Profile</NavItem>
                <NavItem>Help</NavItem>
              </LayoutPanel> : undefined} content={<LayoutContent padding={args.contentPadding} height={args.contentHeight} isScrollable={args.contentIsScrollable}>
            ...
            </LayoutContent>} end={args.showEndPanel ? <LayoutPanel width={args.endPanelWidth} height={args.endPanelHeight} hasDivider={args.endPanelHasDivider} isScrollable={args.endPanelIsScrollable} role="complementary">
  ...
  render: () => <VStack gap={4} xstyle={styles.storySection}>
      ...
      <div {...stylex.props(styles.cwContainer, styles.cwContainer900, styles.cwContainerScrollable)}>
        <Layout contentWidth={640} defaultHasDividers header={<LayoutHeader>
            ...
            </LayoutHeader>} content={<LayoutContent height="auto" role="region" label="Scrollable content width example">
              <p {...stylex.props(styles.bodyText)}>
  ...
  render: () => <VStack gap={4} xstyle={styles.storySection}>
      ...
      <div {...stylex.props(styles.cwContainer, styles.cwContainer900, styles.cwContainerScrollable)}>
        <Layout contentWidth={640} defaultHasDividers header={<LayoutHeader>
              ...
              <NavItem>Privacy</NavItem>
              <NavItem>Notifications</NavItem>
            </LayoutPanel>} content={<LayoutContent height="auto" role="region" label="Scrollable settings content">
              <h4 {...stylex.props(styles.subheading)}>General Settings</h4>
              <br />
              <p {...stylex.props(styles.bodyText)}>
      ...
      <div {...stylex.props(styles.cwContainer, styles.cwContainer1200, styles.cwContainerScrollable)}>
        <Layout contentWidth={800} defaultHasDividers start={<LayoutPanel width={200} hasDivider isScrollable tabIndex={0} role="navigation" label="Independent navigation">
          ...
          length: 12
            ...
            </LayoutPanel>} content={<LayoutContent height="auto" role="region" label="Shared document content">
              {Array.from({
          length: 10
        }, (_, index) => <div key={index} {...stylex.props(styles.placeholder)}>
                  Document section {index + 1}
                </div>)}
            </LayoutContent>} end={<LayoutPanel width={200} hasDivider height="auto" role="complementary" label="Shared details">
              <p {...stylex.props(styles.sectionLabel)}>Details</p>
              <p {...stylex.props(styles.bodyText)}>
